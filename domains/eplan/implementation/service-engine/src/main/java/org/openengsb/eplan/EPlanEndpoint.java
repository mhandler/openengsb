...
public class EPlanEndpoint extends ForwardEndpoint<EPlanDomain> {
    ...
    protected QName getForwardTarget(ContextHelper contextHelper) {
        String defaultName = contextHelper.getValue("eplan/default");
        String serviceName = contextHelper.getValue("eplan/" + defaultName + "/servicename");
        String namespace = contextHelper.getValue("eplan/" + defaultName + "/namespace");
